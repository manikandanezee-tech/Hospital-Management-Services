...
public class ConsultationDAO {
	...
	public ConsultationDTO save(ConsultationDTO consultationDTO) {
		...
		String code = "";
		System.out.println(consultationDTO.getAppointmentDTO().getId());
	...
	public List<ConsultationDTO> getAll(Integer namespaceId) {
		...
		String query = "select c.id, c.code, c.appointment_id, c.chief_complaint, c.diagnosis, c.doctor_notes, c.consultation_datetime, c.active_flag from consultations c inner join appointment a on c.appointment_id=a.id where a.namespace_id = ? and c.active_flag <2";
